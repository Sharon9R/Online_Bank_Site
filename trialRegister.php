...
$INSERT3->close();
$INSERT4 = $conn->prepare("INSERT INTO registration (UserName,UserLoginID,Password,Email_Id,Mobile_no1) values
(?,?,?,?,?)");
$INSERT4->bind_param("sisss",$username,$userloginid,$password,$email,$Mobile_no);
$INSERT4->execute();
